...
100.times do |i|
  Post.create!(
    ...
    phone_contact_number: Faker::PhoneNumber.phone_number,
    type_house: rand(0..1),
    quantity: rand(1..5),
    sex: rand(0..2) ,
...
Post.create(
  ...
  price: 3,
  area: 27,
  description:"Nhà trọ mới xây ngay số  6 Binh Chanh Quận Thủ Đức, nhà xây mới hoàn thiện, thiết kế thao kiểu chưng cư mini, tọa lạc ngay ngã tư Bình Triệu, cách bên xe Miền Đông 5 phút, ngay trường Đại Học Luật Tp HCM, nằm ngay trung tâm tiện lưu thông vào trung tâm Tp.",
...
Post.create(
  ...
  price: 17,
  area: 220,
  description:"Cho thuê mở văn phòng hoặc gia đình ở - nhà nằm trong kdc vạn xuân dream home - đường số 7, tô ngọc vân, thủ đức - kdc an ninh, thoáng mát - đường trước…" ,
  phone_contact_number:"01695669219",
  type_house: 0,
  quantity: 1,
  sex: 2,
...
Post.create(
  ...
  price: 2,
  area: 28,
  description:"Địa chỉ cụ thể 1/3 đường 45,kp2, p. hiệp bình chánh, quận thủ đức. gần chợ bình triệu, coop mart bình triệu. để xe trong phòng. nhà vệ sinh trong. phòng…",
  phone_contact_number:"01695669219",
  type_house: 1,
  quantity: 1,
  sex: 2,
...
Post.create(
  ...
  price: 2.5,
  area: 15,
  description:"Chính chủ cần cho 1 bạn nữ nvvp thuê 1 phòng ngủ nhỏ trong chung cư linh đông 4s thủ đức.phòng rất sạch sẽ, an ninh, riêng tư, yên tĩnh, thoáng mát, có cửa…",
  phone_contact_number:"01695669219",
  type_house: 0,
  quantity: 1,
  sex: 2,
...
Post.create(
  ...
  price: 3.5,
  area: 30,
  description:"Toàn bộ khu nhà gồm 60 căn hộ mini thiết kế rất chuẩn, nội thất đẹp.phòng với diện tích 30m2 được thiết kế 2 gác lửng riêng biệt, thang gổ rất…",
  phone_contact_number:"01695669219",
  type_house: 0,
  quantity: 3,
  sex: 2,
...
Post.create(
  ...
  price: 1.3,
  area: 15,
  description:"Tìm 1 bạn nam vp hoặc sinh viên ở gép gần khu vực coopmark bình triệu, đại học luật. diện tích khoảng 15m2 có gác lững, toilet trong phòng. phòng sạch sẽ",
  phone_contact_number:"01695669219",
  type_house: 0,
  quantity: 1,
  sex: 0,
...
#========
Post.create(
  title:"Phòng mới xây 100% sạch đẹp ven sông,an ninh tốt bảo vệ 24/7, Ngay Chợ Bình Triệu - Đại Học Luật,Chỉ 15p đến Q1",
  price: 2.6,
  area: 25,
...
Post.create(
  ...
  price: 2.3,
  area: 20,
  description:"khối nhà 3 tầng mới xây số 96/6a đường 9, phường linh tây, thủ đức. hẻm cụt rộng 5m, cạnh phạm văn đồng, kha vạn cân giao thông thuận tiện",
  phone_contact_number:"01695669219",
  type_house: 0,
  quantity: 1,
  sex: 2,
...
Post.create(
  ...
  price: 1.7,
  area: 20,
  description:"Cần 1 nam ở ghep, sinh viên hoặc người làm vp gọn gàng sạch sẽ, ít đồ, giờ giấc tự do, có wwifi riêng địa chỉ: đường 18, quận thủ đức, hồ chí minh",
  phone_contact_number:"01695669219",
  type_house: 1,
  quantity: 1,
  sex: 2,
...
Post.create(
  ...
  price: 0.8,
  area: 40,
  description:"Mình đang cần tìm 1 bạn nữ ở ghép. đây là 1 căn nhà cho thuê, phòng trên lầu 2, rộng ,thoáng mát có ban công. -có 1 phòng để quần áo, 1 phòng ngủ riêng",
  phone_contact_number:"01695669219",
  type_house: 0,
  quantity: 1,
  sex: 1,
